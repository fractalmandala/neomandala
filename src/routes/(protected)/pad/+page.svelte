<script lang="ts">
	...
	import { createNewNote, addNewNote, notesDiary } from '$lib/dash/notesutil';
	...
	function confirmNoteSave() {
		...
		id = uuidv4();
		addNewNote(title, text, timestamp, id);
	}
...
<div class="rta-column actualsection">
	<div class="inctualsection">
		<div class="rta-row colgap200 bord-bot titleinputter">
			<button class="blank-button" on:click={confirmNoteSave}>
				<Save dimension={32} />
			</button>
