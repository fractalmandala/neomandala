<script lang="ts">
    ...
    import { useWindowSize } from '$lib/lenis/useWindowSize';
    import { useMediaQuery } from '$lib/lenis/useMediaQuery';
    import { useRect } from '$lib/lenis/useRect';
    import { useScroll } from '$lib/lenis/useScroll';
    import { clamp, mapRange } from '$lib/lenis/maths'
